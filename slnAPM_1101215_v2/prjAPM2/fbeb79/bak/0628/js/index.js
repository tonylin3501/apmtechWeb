...
function updateLogoColor(isHover) {
 ...
 $rectangles.eq(0).addClass('active');
    $('.banner img').eq(0).addClass('animate-pan');
    $('.banner img').attr('aria-hidden', false);
    ...
    $slider.on('beforeChange', function (event, slick, currentSlide, nextSlide) {
      ...
      $('.banner img').eq(nextSlide).addClass('animate-pan');
      setTimeout(() => {
        $('.banner img').eq(currentSlide).removeClass('animate-pan');
      }, 1000);
    });
