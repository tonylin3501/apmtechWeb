    ...
    const interval = setInterval(() => {
      if (percent >= 100) {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
          const wrapItems = document.querySelectorAll(".wrap, .wrap2, .wrap3, .wrap4, .wrap5, .wrap-page2, .wrap-page3, .wrap-page4, .wrap-page5, .wrap-page6, .top-wrap");
    ...
    const interval = setInterval(() => {
      if (percent >= 100) {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            const wrapItems = document.querySelectorAll(".wrap, .wrap2, .wrap3, .wrap4, .wrap5, .wrap-page2, .wrap-page3, .wrap-page4, .wrap-page5, .wrap-page6, .top-wrap");  // 修改這裡，加入所有類別
            wrapItems.forEach((item) => {
              item.classList.add('animate-in-wrap');
            });
          //   setTimeout(() => {
