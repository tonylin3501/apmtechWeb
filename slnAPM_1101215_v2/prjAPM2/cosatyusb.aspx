<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cosatyusb.aspx.cs" Inherits="prjAPM.cosatyusb" %>
            ...
            <div class="success_case_page col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="grideline col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
                    <div class="page_title">
                        <h2>Cosaty 主機及網站外接裝置監控管理平台</h2>
                    </div>
                    <!-- page_title -->
<div> </div>

                    <div>
                        <h4>Cosaty 主機及網站外接裝置監控管理平台(訂閱制授權：12 個月) 市價 9,500(含稅)</h4>
                    </div>
                    <p></p>
<p>⚫ 數量級距:1-10 ,最低購買數／單套授權數1套</p>

 <p></p>
                    <p>Cosaty 主機及網站外接裝置監控管理平台將網站所需的安全防護與管理機制結合在一起，並提供企業完整的網站外接 裝置行為安全的監控管理，解決方案中包括主機網站外接裝置監控管理平台紀錄 檔案新增、刪除、修改及異動等紀錄，大幅提升網站服務品質與安全。 ⚫ 產品特性</p>

                    <p>1. 監控網站主機外接裝置檔案新增等紀錄</p>

                    <p>2. 監控網站主機外接裝置檔案刪除等紀錄</p>

                    <p>3. 監控網站主機外接裝置檔案修改等紀錄</p>

                    <p>4. 監控網站主機外接裝置檔案異動等紀錄</p>

                    <p>5. 結合 Line 告警通知</p>

                    <p>6. 採用 Cosaty 主機及網站外接裝置監控管理平台為您提供完整的網站安全 解 決方案，使用先進的技術提供全面的 Web 網站應用程式安全性，且不會造 成系統效能問題。</p>
