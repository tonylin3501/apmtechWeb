<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cosatyaction.aspx.cs" Inherits="prjAPM.cosatyaction" %>
        ...
        <div class="container-fluid">
            ...
            <div class="success_case_page col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="grideline col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
                    ...
                    <p></p>
                    <div>
                        <h4>Cosaty 主機及網站行為監控管理平台 (訂閱制授權：12 個月) 市價 199,500 (含稅)</h4>
                    </div>
                                      <p></p>
<p>⚫ 數量級距:1-10 ,最低購買數／單套授權數1套</p>
 <p></p>
                    ...
                    <p>Cosaty 主機及網站行為監控管理平台將網站所需的安全防護與管理機制結合在 一 起，並提供企業完整的網站行為安全的監控管理，解決方案中包括主機網站瀏 覽、行為紀錄、檔案開啟編及複製紀錄等，大幅提升網站服務品質與安全。</p>
                    ...
                    <p>3. 監控網站主機網站瀏覽行為紀錄</p>

                    <p>4. 監控網站主機文字輸入行為紀錄</p>

                    <p>5. 監控網站主機通訊軟體開啟紀錄</p>

                    <p>6. 結合 Line 告警通知 7. 採用 Cosaty 網站安全管理行為監控管理平台為您提供完整的網站安全解決 方案，使用先進的技術提供全面的 Web 網站應用程式安全性，且不會造成 系統效能問題。</p>
