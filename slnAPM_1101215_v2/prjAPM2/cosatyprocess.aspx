<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cosatyprocess.aspx.cs" Inherits="prjAPM.cosatyprocess" %>
            ...
            <div class="success_case_page col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="grideline col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
                    <div class="page_title">
                        <h2>Cosaty 主機及網站程式監控管理平台</h2>
                    </div>
                    <!-- page_title -->               

                    <p></p>
                    <div>
                        <h4>Cosaty 主機及網站程式監控管理平台 (訂閱制授權：12 個月) 市價 299,500 (含稅)</h4>
                    </div>
                    <p></p>

<p>⚫ 數量級距:1-10 ,最低購買數／單套授權數1套</p>

                    <p>Cosaty 主機及網站程式監控管理平台將網站所需的安全防護與管理機制結合在一起，並提供完整的 Cosaty 主機 及網 站程式監控管理平台，解決方案中包括主機網站程是行為紀錄等，大幅提升 網站 服務品質與安全。</p>

                    <p>⚫ 產品特性</p>

                    <p>1. 監控網站主機程式行為紀錄</p>

                    <p>2. 監控網站主機程式存取檔案行為紀錄</p>

                    <p>3. 監控網站主機網站檔案下載行為紀錄</p>

                    <p>4. 監控網站主機通訊軟體檔案下載行為紀錄</p>

                    <p>5. 監控網站主機通訊軟體檔案上載行為紀錄</p>

                    <p>6. 禁止網站主機通訊軟體檔案上載行為</p>

                    <p>7. 結合 Line 告警通知 8. 採用 Cosaty 主機及網站程式監控管理平台為您提供完整的網站安全解決方 案，使用先進的技術提供全面的 Web 網站應用程式安全性，且不會造成系 統效能問題。</p>

                    <p>⚫ 作業系統 ➢ 伺服器端電腦的軟體要求 Windows Server 2012 / 2016 / 2019 以上 ➢ 伺服器端電腦的最低硬體要求 * 1 GHz 及以上處理器，8 G RAM，500GB 可用硬碟空間。</p>
